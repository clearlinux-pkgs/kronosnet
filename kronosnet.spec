...
Source0  : https://github.com/kronosnet/kronosnet/archive/v1.27/kronosnet-1.27.tar.gz
...
%prep
%setup -q -n kronosnet-1.27
cd %{_builddir}/kronosnet-1.27
pushd ..
cp -a kronosnet-1.27 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711742996
