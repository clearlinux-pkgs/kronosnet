...
Version  : 1.25
Release  : 3
URL      : https://github.com/kronosnet/kronosnet/archive/v1.25/kronosnet-1.25.tar.gz
Source0  : https://github.com/kronosnet/kronosnet/archive/v1.25/kronosnet-1.25.tar.gz
...
%prep
%setup -q -n kronosnet-1.25
cd %{_builddir}/kronosnet-1.25
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672933888
